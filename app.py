...
videos = [{"url": "https://www.w3schools.com/html/mov_bbb.mp4", "user": "@yousef", "desc": "تجربة مدرسية سرمدا"}]
@app.route('/')
def home():
    q = request.args.get('q','').lower()
    filtered = [v for v in videos if q in v['desc'].lower()] if q else videos
